...
def parse_args(parser):
    ...
    parser.add_argument('--badchars','-b', type=str, action='store', required=False, default ="",
                help='The bad chars to ignore [00 09 0a 0b 0c 0d 20]')
...
def main():
    ...
    bad_chars = args.badchars.lower().split()

    remove_base_address = input(
        Fore.CYAN + "Do you want to remove the base address from the output (y/n): ").lower() == 'y'
